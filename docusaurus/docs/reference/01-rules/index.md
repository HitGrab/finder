...
| [FilterRule](../rules/filter-rule)    | [finder.filter](../api/filter-api)    | Determine what filter predicates are required, and how they should be tested against your Items. |
