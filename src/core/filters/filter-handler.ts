...
import { isMultipleFilterRuleDefinition, isBooleanFilterRuleDefinition, isSingleValueFilterRuleDefinition } from "../utils/rule-utils";
...
export function makeFilterHandler(definition: HydratedFilterRuleDefinition) {
    if (isMultipleFilterRuleDefinition(definition)) {
