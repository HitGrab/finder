...
const apple = { type: "apple", name: "Apple", price: 1, daysUntilExpiryDate: "three" };
const orange = { type: "orange", name: "Orange", price: 2, daysUntilExpiryDate: "five" };
const banana = { type: "banana", name: "Banana", price: 10, daysUntilExpiryDate: "five" };
const objectItems = [apple, orange, banana];
describe("Search", () => {
    test("Search", () => {
        const config = finderConfig({
            searchFn: (item, searchTerm) => item.type === searchTerm,
        });
        const initialValues = {
            searchTerm: "apple",
        };
