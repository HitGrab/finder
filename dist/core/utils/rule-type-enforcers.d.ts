...
export declare function ruleHook<FItem, FContext = any>(rules: string | FinderRule<FItem> | (string | FinderRule<FItem>)[], onChange: (instance: FinderCore<FItem, FContext>) => void): {
