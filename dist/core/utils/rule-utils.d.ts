...
import { FilterRuleUnionDefinition, FilterRuleWithBooleanValue, FilterRuleWithMultipleValues, FilterRuleWithSingleValue, GroupByRuleDefinition, HydratedFilterOptions, SearchRuleDefinition, SortByRuleDefinition } from "../types/rule-types";
...
export declare function isFilterRuleDefinitionWithHydratedOptions<FItem>(rule: unknown): rule is FilterRuleUnionDefinition<FItem> & HydratedFilterOptions;
...
export declare function isMultipleValueFilterRuleDefinition<FItem>(rule: unknown): rule is FilterRuleWithMultipleValues<FItem, unknown>;
export declare function isSingleValueFilterRuleDefinition<FItem>(rule: unknown): rule is FilterRuleWithSingleValue<FItem, unknown>;
