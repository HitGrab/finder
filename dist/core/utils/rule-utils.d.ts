...
export declare function getFilterOptionFromIdentifier<FItem>(optionOrOptionValue: FilterOption | any, options: FilterOption[] | ((items: FItem[], context?: InjectedContext) => FilterOption[]) | undefined, items: FItem[], context?: InjectedContext): any;
