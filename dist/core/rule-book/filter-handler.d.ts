import { FilterRuleUnionDefinition, HydratedFilterOptions } from "../types/rule-types";
export declare function makeFilterHandler(definition: FilterRuleUnionDefinition & HydratedFilterOptions): {
